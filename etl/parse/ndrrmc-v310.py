...
OUTPUT_FOLDER = "NDRRMC_PARSED_VER3.10"   # NEW OUTPUT FOLDER
FOLDER_LENGTH = 0
...
class SimpleTitleTracker:
    ...
    def check_page_bottom(self, page, page_num):
        """Look for potential title at bottom of page."""
        page_height = page.height
        bottom_y = page_height - 100
        ...
        for line in reversed(lines):
            ...
            if line.isupper() or 'as of' in line.lower():
                self.pending_title = line
                self.pending_title_page = page_num
                print(f"   → Found potential title at bottom of page {page_num}: {line}")
                return line
