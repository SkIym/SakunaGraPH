...
DEFAULT_SHAPES_PATH = ROOT_DIR / "ontology" / "shapes" / "shapes.ttl"
...
DEFAULT_DATA_GRAPH_PATTERNS = (
    ...
    ROOT_DIR / "data" / "rdf" / "events" / "emdat" / "*.ttl",
    ROOT_DIR / "data" / "rdf" / "events" / "dromic" / "*.ttl",
    ROOT_DIR / "data" / "rdf" / "events" / "ndrrmc" / "*.ttl",
