...
CLASSIFICATION_RULES: list[ClassificationRule] = [
    ...
    (["epidemic", "disease outbreak", "infectious disease",
      "gastroenteritis", "gastro-enteritis", "gastroentritis", "gastro-entritis",
      "diarrhea outbreak", "diarrhoea outbreak"],                                "InfectiousDiseaseGeneral"),
