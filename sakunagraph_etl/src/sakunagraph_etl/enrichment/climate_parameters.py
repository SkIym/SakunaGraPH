...
ONTOLOGY_PATH = str(SETTINGS.paths.ontology_root / "sakunagraph.ttl")
DEFAULT_MODEL = "fastino/gliner2-base-v1"
DEFAULT_MODEL_REVISION = "839d6dcc640d712ecf0b5a6e54d0558c7ef9885e"
...
class ClimateParameterExtractor:
    def __init__(
        ...
        self.model_revision = os.getenv("GLINER2_MODEL_REVISION", model_revision)
    ...
    def _load_extractor(self) -> Any:
        ...
        self._extractor = GLiNER2.from_pretrained(model_path)
        return self._extractor
