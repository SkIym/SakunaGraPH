...
from ._classification_rules import (
...
ONTOLOGY_PATH = SETTINGS.paths.ontology_root / "disaster_type_scheme.ttl"
...
DISASTER_CLASSIFIER = DisasterClassifier(
    model_name=os.getenv("SAKUNA_DISASTER_MODEL", DEFAULT_MODEL),
    model_revision=os.getenv(
        "SAKUNA_DISASTER_MODEL_REVISION",
