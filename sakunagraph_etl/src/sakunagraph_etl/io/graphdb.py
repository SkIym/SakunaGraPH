...
transaction while still letting GraphDB optimize replacement without a
...
def transactions_url(host: str, repo: str) -> str:
    """Return the legacy RDF4J transaction endpoint for compatibility callers."""
...
def replace_context(
    ...
    try:
        ...
        # may be repeated between statement groups. A temporary file bounds
        # memory use and gives requests a Content-Length for large source graphs.
