...
INPUT_FOLDER = str(SETTINGS.paths.raw_root / "ndrrmc_new")
OUTPUT_FOLDER = str(SETTINGS.paths.parsed_root / "ndrrmc")
FOLDER_LENGTH = 0
...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--input-dir", type=Path, help="NDRRMC PDF input directory")
    parser.add_argument("--output-dir", type=Path, help="Parsed event output directory")
    return parser
...
def main(argv: list[str] | None = None) -> int:
    ...
    INPUT_FOLDER = str(args.input_dir or SETTINGS.paths.raw_root / "ndrrmc_new")
    OUTPUT_FOLDER = str(args.output_dir or SETTINGS.paths.parsed_root / "ndrrmc")
